...
for (x in 1:sum(tab6h$raw.p.value < 0.05)) {
  ...
  conditionalFormatting(excel, sheetname, cols=8, rows=2:nrow(GoDF[[x]]), rule="<0.01", style = posStyle)
...
for (x in 1:sum(tab12h$raw.p.value < 0.05)) {
  ...
  conditionalFormatting(excel, sheetname, cols=6, rows=2:nrow(GoDF[[x]]), rule="<0.01", style = posStyle)
...
for (x in 1:sum(tab24h$raw.p.value < 0.05)) {
  ...
  conditionalFormatting(excel, sheetname, cols=7, rows=2:nrow(GoDF[[x]]), rule="<0.01", style = posStyle)
